...
pub const DEFAULT_REPO: &str = "infomiho/diktafon";
pub const REPOSITORY_URL: &str = "https://github.com/infomiho/diktafon";
pub const LATEST_RELEASE_URL: &str = "https://github.com/infomiho/diktafon/releases/latest";
...
impl Github {
    pub fn from_env() -> Self {
        ...
        let client = reqwest::Client::builder()
            .user_agent(concat!("diktafon-web/", env!("CARGO_PKG_VERSION")))
